...
%% \tnotetext[label1]{}
 \author{Jagdish Chakole\corref{cor1}\fnref{label1}}
 \ead{jchakole@iiitn.ac.in}
%% \ead[url]{home page}
%% \fntext[label2]{}
\author{Muktinath Vishwakarma\fnref{label2}}
\ead{author2@example.com}
\author{Nachiket N Doddamani\fnref{label1}}
\ead{nachiketdoddamani@gmail.com}
\author{Manish Kurhekar\fnref{label2}}
...
\title{Unleashing the Power of Deep Learning: A Performance Comparison of LSTM, GRU, and Transformer Models}
